...
G4VPhysicalVolume *MyDetectorConstruction::Construct(){
     ...
     G4double energy[2] = {1.239841939*eV/0.9, 1.239841939*eV/0.2}; /// changed the 0.9 and 0.2 compared to the tutorial; the energy values are in increasing order.
     ...
     G4VPhysicalVolume *physWorld = new G4PVPlacement(0, G4ThreeVector(0.,0.,0.), logicWorld, "physWorld", 0, false, 0, true); // last true is to check the overlaps
